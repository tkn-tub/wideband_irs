...
%   Copyright 2023 The MathWorks, Inc.
    ...
    methods
        ...
        function obj = hpre6GRISChannel(varargin)
            ...
            obj.Ch1.SampleRate =491520000 ;

            % Tx array
            txArrayCh1 = struct(Size=[1 1 1 1 1],ElementSpacing=[0.5 0.5 1 1],PolarizationAngles=[45 -45], ...
                Element='38.901',PolarizationModel='Model-2');
            obj.Ch1.TransmitAntennaArray = txArrayCh1;

            % ch1 rx antenna array is the RIS
            rxArrayCh1 = struct(Size=[40 40 2 1 1],ElementSpacing=[0.5 0.5 1 1],PolarizationAngles=[45 -45], ...
